...
{
$ret=mysqli_query($con,"SELECT * FROM doctors WHERE docEmail='".$_POST['username']."' and password='".md5($_POST['password'])."' and estado=1");
...
$_SESSION['errmsg']="usuario o contraseña inválida";
$extra="index.php";
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
exit();
...
<html lang="en">
	<head>
		<title>Especialista Login</title>
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html">	<h2> HPS | Login Especialista</h2></a>
				</div>
				...
				<div class="box-login flex" >
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Ingrese se Email y su contraseña para iniciar sesion<br />
