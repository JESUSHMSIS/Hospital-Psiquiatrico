...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
    ...
    if ($query) {
    echo '<script>alert("Historial medico añadido")</script>';
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
  <tr align="center">
   <th colspan="8" >Hisorial medico</th> 
  </tr>
  <tr>
    <th>#</th>
<th>Presion de sangre</th>
<th>Peso</th>
...
<p align="center">                            
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Añadir historial medico</button></p>  
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Añadir historial medico</h5>
    ...
    <th>Presion de sangre :</th>
    <td>
    <input name="bp" placeholder="Presion de sangre" class="form-control wd-450" required="true"></td>
  </tr>                          
     <tr>
    <th>Nivel de azucar:</th>
    <td>
    <input name="bs" placeholder="Nivel de azucar" class="form-control wd-450" required="true"></td>
  </tr> 
  <tr>
    <th>Peso:</th>
    <td>
  ...
  <tr>
    <th>Tempratura :</th>
    <td>
    <input name="temp" placeholder="Termperatura" class="form-control wd-450" required="true"></td>
  </tr>
