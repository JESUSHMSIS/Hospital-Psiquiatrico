...
<html lang="en">
	<head>
		<title>Especialista | Editar paciente</title>
...
<div class="form-group">
              ...
              <input type="radio" name="gender" id="gender" value="femenino">Female
              </label>
             <?php } ?>
            </div>
<div class="form-group">
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Ingresa historial medico de paciente" required="true"><?php  echo $row['PatientMedhis'];?></textarea>
</div>	
<div class="form-group">
<label for="fess">
 Fecha de creacion
