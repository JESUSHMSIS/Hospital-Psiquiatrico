...
echo "<script>alert('Datos invalidos. Ingresa datos validos');</script>";
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html"><h2> HPS | Recuperar contraseña Especialista</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
								Recuperar contraseña Especialista
							</legend>
							<p>
								Por favor ingresa tu numero de contacto y email para recuperar tu contraseña.<br />
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-primary pull-right" name="submit">
									Resetear <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
