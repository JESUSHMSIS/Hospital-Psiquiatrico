...
// Verificar si el usuario tiene el rol de "especialista"
...
<body>
<h1>Bienvenido, <?php echo isset($_SESSION['doctorId']) ? $_SESSION['especialistaId'] : 'Especialista'; ?></h1>
    ...
    <?php if (!empty($videos)) : ?>
        <?php foreach ($videos as $video) : ?>
            <div class="youtube-video">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo getYouTubeVideoId($video['enlace']); ?>" frameborder="0" allowfullscreen></iframe>
            </div>
        <?php endforeach; ?>
    <?php else : ?>
