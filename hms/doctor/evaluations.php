...
<p align="center">
  <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Añadir evaluación</button>
</p>
        ...
        <table class="table table-bordered table-hover data-tables">
          <form method="post" name="submit">
            <tr>
              <th>Síntomas:</th>
              <td>
                <input name="symptoms" placeholder="Síntomas" class="form-control wd-450" required="true">
              </td>
            </tr>
            <tr>
              <th>Diagnóstico:</th>
              <td>
                <input name="diagnosis" placeholder="Diagnóstico" class="form-control wd-450" required="true">
              </td>
            </tr>
            <tr>
              <th>Comentarios del Especialista:</th>
              <td>
                <textarea name="comments" placeholder="Comentarios del Especialista" rows="12" cols="14" class="form-control wd-450" required="true"></textarea>
              </td>
            </tr>
            <tr>
              <th>Calificación de Progreso:</th>
              <td>
                <input type="number" name="rating" placeholder="Calificación de Progreso" class="form-control wd-450" required="true">
              </td>
            </tr>
          </table>
        </div>
