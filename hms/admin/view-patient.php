...
<html lang="en">
	<head>
		<title>Doctor | Historial de paciente </title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Admin | Detalles de paciente</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Admin</span>
...
<li class="active">
<span>Detalles de paciente</span>
</li>
</ol>
</div>
</section>
...
<td colspan="4" style="font-size:20px;color:blue">
 Detalles de paciente</td></tr>

    <tr>
    <th scope>Nombre de paciente</th>
    <td><?php  echo $row['PatientName'];?></td>
    <th scope>Email de paciente</th>
