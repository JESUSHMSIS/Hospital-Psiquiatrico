...
<html lang="en">
	<head>
		<title>Admin | Añadir Especialidad</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Añadir Especialista</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Añadir Especialista</h5>
												</div>
...
<input type="email" id="docemail" name="docemail" class="form-control"  placeholder="Ingresa Email " required="true" onBlur="checkemailAvailability()">
