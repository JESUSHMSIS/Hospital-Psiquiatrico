...
if(isset($_GET['del']))
{
    mysqli_query($con, "UPDATE usuarios_simulador SET estado = 0 WHERE id = '".$_GET['id']."'");
...
<html lang="en">
	<head>
		<title>Admin | Ver simualdores</title>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Ver <span class="text-bold">Simuladores</span></h5>
	
<table class="table table-hover" id="sample-table-1">
<thead>
<tr>
<th class="center">#</th>
<th>Nombre del simulador</th>
<th>A paterno</th>
<th>A materno </th>
<th>CI</th>
...
$sql=mysqli_query($con,"select * from usuarios_simulador where estado = 1");
$cnt=1;
