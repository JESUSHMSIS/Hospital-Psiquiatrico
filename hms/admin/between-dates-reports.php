...
<html lang="en">
	<head>
		<title>B/w Reportes entre fechas | Admin</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Fechas de reportes | Reportes</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Fechas entre</span>
									</li>
									<li class="active">
										<span>Reportes</span>
									</li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Reportes entre Fechas</h5>
												</div>
