...
if(isset($_POST['reactivar'])) {
    $id = $_POST['id'];
    mysqli_query($con, "UPDATE users SET estado = 1 WHERE id = $id");
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Lista de Usuarios</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Admin</span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql=mysqli_query($con,"select * from users where estado=0");
                                        $cnt=1;
