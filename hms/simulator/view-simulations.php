...
if (isset($_GET['del']) && isset($_GET['ID'])) {
    $videoId = $_GET['ID'];
    mysqli_query($con, "DELETE FROM simulaciones WHERE id = '$videoId'");
    $_SESSION['msg'] = "El video se ha eliminado correctamente.";
}
                                    ...
                                    <?php if(!empty($simulaciones)) : ?>
                                        <?php foreach ($simulaciones as $simulacion) : ?>
                                            <div class="youtube-video">
                                                ...
                                                ?>
                                                <a href="?ID=<?php echo urlencode($simulacion['video_id']); ?>&del=delete" onClick="return confirm('¿Estás seguro de que quieres eliminarlo?')" class="btn-delete">Eliminar</a>
                                            </div>
                                        <?php endforeach; ?>
                                    <?php else : ?>
