...
{
$sql=mysqli_query($con,"SELECT password FROM  usuarios_simulador where password='".md5($_POST['cpass'])."' && email='".$_SESSION['email']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update usuarios_simulador set password='".md5($_POST['npass'])."', updationDate='$currentTime' where email='".$_SESSION['email']."'");
...
<html lang="en">
	<head>
		<title>Simulador  | Cambira contraseña</title>
...
{
alert("Contraseña actual esta vacia !!");
document.chngpwd.cpass.focus();
return false;
}
else if(document.chngpwd.npass.value=="")
{
alert("Nueva contraseña esta vacia !!");
document.chngpwd.npass.focus();
return false;
}
else if(document.chngpwd.cfpass.value=="")
{
alert("Confirmar contraseña esta vacio !!");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Simulador | Cambiar contraseña</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Simulador</span>
